            ...
            <div id="sidebar" className="span3">
                <div className="well well-small">
                    <ul className="nav nav-list">
                        ...
                        <li><a href="products.html"><span className="icon-chevron-right" />Engagement &amp; Wedding</a>
                        </li>
                        ...
                        <li><a href="products.html"><span className="icon-chevron-right" />See All Jewelry &amp;
                      Watches</a></li>
                ...
                <div className="well well-small alert alert-warning cntr">
                    <h2>50% Discount</h2>
                    <p>
                        only valid for online order. <br /><br /><a className="defaultBtn" href="cart.html">Click here </a>
                    </p>
                </div>
                <div className="well well-small"><a href="cart.html"><img src="assets/img/paypal.jpg" alt="payment method paypal" /></a></div>
                <a className="shopBtn btn-block" href="cart.html">Upcoming products <br /><small>Click to view</small></a>
                <br />
                <br />
