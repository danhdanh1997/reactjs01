                 ...
                 <div className="navbar">
                    <div className="navbar-inner">
                        <div className="container">
                            <a href="list-view.html" data-target=".nav-collapse" data-toggle="collapse" className="btn btn-navbar">
                            ...
                            <div className="nav-collapse">
                                ...
                                <ul className="nav pull-right">
                                    <li className="dropdown">
                                        <a data-toggle="dropdown" className="dropdown-toggle" href="general.html"><span className="icon-lock" /> Login <b className="caret" /></a>
