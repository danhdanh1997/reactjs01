                    ...
                    <div className="container">
                        <div className="alignR">
                            <div className="pull-left socialNw">
                                <a href="contact.html"><span className="icon-twitter" /></a>
                                <a href="contact.html"><span className="icon-facebook" /></a>
                                <a href="contact.html"><span className="icon-youtube" /></a>
                                <a href="contact.html"><span className="icon-tumblr" /></a>
                            </div>
                            <a className="active" href="index.html"> <span className="icon-home" /> Home</a>
                            <a href="contact.html"><span className="icon-user" /> My Account</a>
